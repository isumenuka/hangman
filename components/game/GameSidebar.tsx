...
interface GameSidebarProps {
    ...
    onCastSpell: (spell: 'FOG' | 'SCRAMBLE' | 'JUMPSCARE', targetId?: string) => void; // targetId handled internally by spellToCast logic if passed up? No, App handles it via castSpell. 
    ...
    performSpellAction: (spell: 'FOG' | 'SCRAMBLE' | 'JUMPSCARE', targetId: string) => void;
                    ...
                    {gameMode !== 'SINGLE' && gameMode !== 'DAILY' && (
                        <div className="mb-4 space-y-2">
                            ...
                            {status === GameStatus.WON && (
                                <button
                                    disabled={hasScared}
                                    onClick={() => initiateCastSpell('JUMPSCARE')}
                                    className={clsx(
